...
public class ScheduleDayOneFragment extends Fragment
{
    ...
    public ScheduleDayOneFragment()
    {
        // Required empty public constructor
    }


    public static ScheduleDayOneFragment newInstance(String param1, String param2)
    {
        ScheduleDayOneFragment fragment = new ScheduleDayOneFragment();
    ...
    private void setupScheduleAdapter()
    {
        ...
        Query q = firebaseFirestore.collection("/INSTRUO_SCHEDULE/DAY_1/SCHEDULES").orderBy("timing");
